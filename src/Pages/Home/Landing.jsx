  ...
  return (
    <div style={props.style}>
      ...
      <Header topSpace={{ md: true }} type="reverse-scroll">
        <HeaderNav theme="light" expand="lg" className="spasalon-header py-[0px] px-[35px] md:px-[15px] md:py-[20px] sm:px-0 border-b border-[#ffffff1a]" fluid="fluid" containerClass="md:pr-0">
      ...
      <section className="pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px] bg-cover bg-no-repeat relative bg-center" style={{ backgroundImage: 'url(https://via.placeholder.com/1920x625)' }}>
        ...
        <Container>
          <Row className="mt-36 md:mt-24 sm:mt-16">
            <Col lg={5} md={6}>
              <m.h2 className="heading-5 font-serif font-medium leading-[46px] -tracking-[.5px] md:leading-[38px] text-darkgray md:m-0 sm:leading-[36px] xs:mb-[15px]" {...{ ...fadeIn, transition: { delay: 0.2 } }}>Pakketten om online te volgen. Helder, veilig, en betaalbaar op je eigen tempo werken aan je gezondheid.</m.h2>
            </Col>
        ...
        <Container>
          <Row className="justify-center">
            <m.div className="text-left md:text-center md:mb-[50px] col-lg-4 col-sm-8" {...{ ...fadeIn, transition: { delay: 0.2 } }}>
              <span className="font-serif font-medium text-gradient bg-gradient-to-r from-[#ec606c] to-[#eb7242] uppercase inline-block mb-[15px] sm:mb-[5px]">{textTestimonalsHeader}</span>
              <h2 className="heading-5 font-serif font-medium text-darkgray tracking-[-1px] m-0">{textTestimonalsText}</h2>
            </m.div>
            <m.div className="col-xl-7 col-lg-8 offset-xl-1" {...{ ...fadeIn, transition: { delay: 0.6 } }}>
              <TestimonialsCarousel05 data={TestimonialsCarouselData} carouselOption={{ slidesPerView: 1, loop: true, navigation: false, autoplay: { delay: 10000, disableOnInteraction: false }, }} />
            </m.div>
          </Row>
        </Container>
      </section>
