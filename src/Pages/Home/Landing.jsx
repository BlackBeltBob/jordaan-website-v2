...
const LandingPage = (props) => {
  ...
  return (
    <div style={props.style}>
          ...
          <Row className="justify-center">
            <Col lg={6} sm={8} className="text-center mb-24 md:mb-12 xs:mb-16">
              <m.span className="block mb-[40px] md:mb-[25px] xs:mb-[15px]" {...fadeIn}><img width={150} height={78}
                                                                                             src="https://via.placeholder.com/150x78"
                                                                                             className="my-0 mx-auto"
                                                                                             alt="spa"
                                                                                             data-no-retina=""/>
              </m.span>
              <m.span
                className="inline-block font-serif text-spanishgray uppercase font-medium mb-[15px] tracking-[1px] xs:mb-[10px]" {...fadeIn}>Enjoy
                soothing experience
              </m.span>
              <m.h2 className="heading-5 font-serif text-darkgray font-medium tracking-[-1px]" {...fadeIn}>Welcome to
                our soothing spa massage therapy center
              </m.h2>
            </Col>
          </Row>
      ...
      <section className="pb-[130px] lg:pb-[90px] md:pb-[75px] sm:pb-[50px] bg-cover bg-no-repeat relative bg-center"
        ...
        <Container>
          <Row className="mt-36 md:mt-24 sm:mt-16">
            <Col lg={5} md={6}>
              <m.h2
                className="heading-5 font-serif font-medium leading-[46px] -tracking-[.5px] md:leading-[38px] text-darkgray md:m-0 sm:leading-[36px] xs:mb-[15px]" {...{
                ...fadeIn,
                transition: {delay: 0.2}
              }}>Pakketten om online te volgen. Helder, veilig, en betaalbaar op je eigen tempo werken aan je
                gezondheid.
              </m.h2>
            </Col>
            <m.div md={6} className="col-lg-6 col-md-6 offset-lg-1" {...{...fadeIn, transition: {delay: 0.4}}}>
              <p className="w-[85%] lg:w-full mb-[20px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit sed do
      ...
      <section className="py-[130px] lg:py-[90px] md:py-[75px] sm:py-[50px] cover-background"
               style={{backgroundImage: 'url(https://via.placeholder.com/1920x823)'}}>
        <Container>
          <Row className="items-center justify-center">
            <Col lg={6} className="text-start lg:text-start md:mb-[30px]">
              <img className="md:mx-auto" src="https://via.placeholder.com/611x669" width="555" height="607.67"
              ...
              <Row className="row row-cols-1 justify-center">
                ...
                <Col className="mb-[40px] sm:mb-[30px]">
                  <div className="items-center justify-start text-left flex">
                    <div className="mr-[35px] xs:mr-[15px]">
                      <m.img
                        className="rounded-full shadow-[0_0_15px_rgba(0,0,0,0.1)] h-[130px] w-[130px] border-8 border-white xs:h-[80px] xs:w-[80px]"
                        src="https://via.placeholder.com/250x250" alt="" data-no-retina="" {...{
                        ...zoomIn,
                        transition: {duration: 0.7}
                      }} />
                    ...
                    <m.div className="flex-1" {...{...fadeInLeft, transition: {delay: 0.4, duration: 1}}}>
                      <span
                        className="font-serif text-darkgray inline-block font-medium mb-[5px]">Relax with luxury spa</span>
                      <p>Lorem ipsum dolor consectetur adipiscing elit sed do eiusmod tempor incididunt.</p>
                    </m.div>
                  </div>
                </Col>
                <Col>
                  <div className="items-center justify-start text-left flex">
                    ...
                    <m.div className="flex-1" {...{...fadeInLeft, transition: {delay: 0.4, duration: 1}}}>
                      <span
                        className="font-serif text-darkgray inline-block font-medium mb-[5px]">Ayurvedic treatments</span>
                      <p>Lorem ipsum dolor consectetur adipiscing elit sed do eiusmod tempor incididunt.</p>
                    </m.div>
                  </div>
                </Col>
      ...
      {/* Section Start */}
      <section
        className="py-[130px] pb-[500px] xl:pb-[450px] lg:pt-[90px] md:pt-[75px] sm:py-[50px] bg-cover bg-no-repeat overflow-hidden relative bg-center"
        ...
        <Container>
          <Row className="row overlap-gap-section justify-center items-center">
            <Col className="col-12 col-lg-8 col-sm-9 text-center">
              ...
              <m.div {...{...zoomIn, transition: {duration: 0.7}}}>
                <CustomModal.Wrapper
                  ...
                  modalBtn={<Buttons ariaLabel="modal link" type="submit"
                                     className="btn-sonar border-0 mx-auto mb-[30px]" themeColor="#fff" size="xl"
                                     title={<i
                                       className="icon-control-play text-gradient bg-gradient-to-tr from-[#ec606c] to-[#eb7242]"/>}/>}>
                  <div className="w-[1020px] max-w-full relative rounded mx-auto">
                    <div className="fit-video">
                      <iframe width="100%" height="100%" className="shadow-[0_0_8px_rgba(0,0,0,0.06)]" controls
                              src="https://www.youtube.com/embed/g0f_BRYJLJE?autoplay=1" title="YouTube video player"
                              frameBorder="0"
              ...
              {/* Modal Component End */}
              <m.h2 className="heading-4 font-serif font-extralight text-white mb-0" {...fadeIn}><span
                className="font-semibold">True meditation</span> is letting go of manipulating our experience
              </m.h2>
            </Col>
          </Row>
        </Container>
                  ...
                  <div
                    ...
                    <div>
                      ...
                      <div
                        ...
                        salon refresh hot round stone massage
                      </div>
