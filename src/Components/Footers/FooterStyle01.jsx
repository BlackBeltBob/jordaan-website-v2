                ...
                <Container>
                    <Row>
                        ...
                        <Col lg={3} sm={6} className="xs:mb-[25px]">
                            <span className="mb-[20px] font-serif block font-medium text-themecolor xs:mb-[10px]">U vind ons hier</span>
                            <p className="w-[85%] mb-[15px]">Westerstraat 238, 1015 MT, Amsterdam</p>
                            <div><i className="feather-phone-call text-sm mr-[10px] text-themecolor"></i>+31 20 623 5136</div>
                            <div><i className="feather-mail text-sm mr-[10px] text-themecolor"></i><a aria-label="mail" href="mailTo:info@mensendieck-fysiotherapie.nl">info@mensendieck-fysiotherapie.nl</a></div>
                        </Col>
                        <Col lg={3} sm={6}>
                ...
                <Container>
                    <Row>
                        ...
                        <Col md={6} className="flex justify-center items-center text-center sm:mb-[20px]">
                            <p className="mb-0">&copy; {new Date().getFullYear()} Mensendieck Jordaan</p>
                        </Col>
